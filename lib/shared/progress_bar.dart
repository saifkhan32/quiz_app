...
class ProgressBar extends StatelessWidget {
  final double value;
  final double height;
  const ProgressBar ({super.key, required this.value,  this.height = 18});
...
class TopicProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      return Row(children: [
        ...
        Expanded(child: ProgressBar(value: _calculateProgress(topic,report),height: 8,))
      ],);
  }
